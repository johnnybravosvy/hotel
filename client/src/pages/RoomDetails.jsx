...
const RoomDetails = () => {
  ...
  const checkAvailability = async () => {
    try {
      ...
      const { data } = await axios.post("/api/bookings/check-availabiity", {
        room: id,
        checkInDate,
        checkOutDate,
      });
    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            Guests will be accommodated in a spacious and comfortable room with
            all necessary amenities. Guests will be allocated on the ground
            floor according to availability. You get a comfortable two bedroom
            apartment that has a true city feeling. The price quoted is for 2
            guests, at the guest slot, please mark the number of guests in the
            booking form. Taxes have not been included in the quoted price.
          </p>
        </div>
