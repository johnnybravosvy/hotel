...
const MyBookings = () => {
  ...
  return (
    <div className="py-28 md:pb-35 px-4 md:pt-32 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="My Bookings"
        subTitle="Manage your bookings here. Easily manage your past, current and upcoming rooms reservations in one place. Plan your trips seamlessly with just a few clicks"
        align="left"
      />
